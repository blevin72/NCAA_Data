...
namespace NCAA_Data
{
	public class KickReturns : Base
	{
        ...
        public override void GetParameters()
        {
            ...
            Console.WriteLine("Which kick return stat would you like to see: YDS, TD, LONG, NO");
            StatType = Console.ReadLine().ToUpper();
        }

        public override async Task DisplayStatistics()
        {
            string selectedCategory = "kickReturns";
            ...
            {
                if (playerStats.Category == selectedCategory) //had to remove .ToLower b/c the API has kickReturns
                {
