...
namespace NCAA_Data
{
    public class PuntReturns : Base
    {
        ...
        public override void GetParameters()
        {
            ...
            Console.WriteLine("Which punt return stat would you like to see: YDS, TD, LONG");
            StatType = Console.ReadLine().ToUpper();
        }

        public override async Task DisplayStatistics()
        {
            string selectedCategory = "puntReturns";
            ...
            {
                if (playerStats.Category == selectedCategory) //had to remove .ToLower b/c the API has puntReturns
                {
